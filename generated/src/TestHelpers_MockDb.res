...
@genType
and entities = {
    @as("Beneficiary") beneficiary: entityStoreOperations<Entities.Beneficiary.t>,
    @as("BeneficiaryExecution") beneficiaryExecution: entityStoreOperations<Entities.BeneficiaryExecution.t>,
    @as("Deposit") deposit: entityStoreOperations<Entities.Deposit.t>,
    @as("Execution") execution: entityStoreOperations<Entities.Execution.t>,
    @as("Permission") permission: entityStoreOperations<Entities.Permission.t>,
    @as("TriggerEvent") triggerEvent: entityStoreOperations<Entities.TriggerEvent.t>,
    @as("Vault") vault: entityStoreOperations<Entities.Vault.t>,
    @as("VaultStats") vaultStats: entityStoreOperations<Entities.VaultStats.t>,
    @as("Withdrawal") withdrawal: entityStoreOperations<Entities.Withdrawal.t>,
  }
  ...
  let entities = {
      beneficiary: {
        makeStoreOperatorEntity(
          ...
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.Beneficiary)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.Beneficiary.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      beneficiaryExecution: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.BeneficiaryExecution)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.BeneficiaryExecution.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      deposit: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.Deposit)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.Deposit.t,
            >
      ...
      execution: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.Execution)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.Execution.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      permission: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.Permission)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.Permission.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      triggerEvent: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.TriggerEvent)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.TriggerEvent.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      vaultStats: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.VaultStats)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.VaultStats.t,
            >
          ),
          ~getKey=({id}) => id,
        )
      ...
      withdrawal: {
        makeStoreOperatorEntity(
          ...
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db->InMemoryStore.getInMemTable(
            ~entityConfig=module(Entities.Withdrawal)->Entities.entityModToInternal,
          )->(
            Utils.magic: InMemoryTable.Entity.t<Internal.entity> => InMemoryTable.Entity.t<
              Entities.Withdrawal.t,
            >
          ),
          ~getKey=({id}) => id,
        )
